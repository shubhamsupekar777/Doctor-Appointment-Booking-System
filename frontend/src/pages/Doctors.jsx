...
//                                                <img
//                                      className="w-full h-64 object-cover bg-[#EAEFFF]"
//   src={item.image}
//   alt=""
// />
//               <div className='p-4'>
...
const Doctors = () => {
  ...
  const doctorsBasePath = isPatientPortal
    ? '/patient/doctors'
    : '/doctors'
  ...
  const goToSpeciality = (specialityName) => {
    if (speciality === specialityName) {
      navigate(doctorsBasePath)
    } else {
      navigate(`${doctorsBasePath}/${specialityName}`)
    }
  }
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        >
          ...
          <p
            onClick={() => goToSpeciality('General physician')}
          ...
          <p
            onClick={() => goToSpeciality('Gynecologist')}
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
          ...
          <p
            onClick={() => goToSpeciality('Dermatologist')}
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
          ...
          <p
            onClick={() => goToSpeciality('Pediatricians')}
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
          ...
          <p
            onClick={() => goToSpeciality('Neurologist')}
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
          ...
          <p
            onClick={() => goToSpeciality('Gastroenterologist')}
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
